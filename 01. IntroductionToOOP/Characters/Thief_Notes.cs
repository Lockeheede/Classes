...
namespace IntroductionToOOP.Characters.Body
{
    ...
    //Inheritance works in the Thief.cs and Muse.cs classes. Instead of all the redundant code, I put the common code in the Character.cs
    //And inherit this from the two other classes (ie: public class Thief : Character) I may need to use a namespace to do this, too.
    public class Thief
    {
        ...
        //static methods are methods you make without instansiating the class first
        //These include Console.WriteLine(); or Array.Copy();
